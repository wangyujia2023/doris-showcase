...
-- ================================================================
-- London Underground (TfL) operations tables
-- ================================================================
...
CREATE TABLE IF NOT EXISTS `bj_metro_lines` (
  ...
  `total_length_km` decimal(8,2) NULL,
  `open_year` int NULL,
  `daily_capacity_w` int NULL COMMENT 'daily capacity (10k passengers)',
  `peak_interval_s` int NULL COMMENT 'peak headway (seconds)',
  `offpeak_interval_s` int NULL COMMENT 'off-peak headway (seconds)',
  `status` varchar(20) NULL
) ENGINE=OLAP
UNIQUE KEY(`line_id`)
DISTRIBUTED BY HASH(`line_id`) BUCKETS 3
